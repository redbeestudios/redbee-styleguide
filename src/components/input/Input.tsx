...
const validateOnlyNumbers = (onlyNumbers, e, innerValue, setInnerValue) => {
 ...
 const Input =( props:InputProps )=>{
    ...
    const [inputType, setInputType] = useState(props.onlyNumbers ? 'text' : props.type);
    ...
    const renderMaxLengthHelpText = () => (
        <S.SiblingInputTag>
            <Span font='primary' type='2' variant='neutral' weight='regular' modifier='regular'>
    ...
    return <S.Input >
        ...
        {props.message && (
            <S.HelpText status={props.inputStatus}>
                ...
                <Span font='primary' modifier='regular' type='4' weight='regular' variant={spanVariantByStatus[props.inputStatus]}>
                    {props.message}
                </Span>
            </S.HelpText>
        )}
