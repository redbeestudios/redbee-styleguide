...
export interface BadgeStylesProps {
    ...
    variant?:'danger'|'info'|'warning'|'success'|'neutral-1'|'neutral-2'|'primary'|'default'|'neutral-n-4'|'white',
    modifier?:'weak'|'regular'|'strong'|'inverted'
    size?:'sm'|'md',
    border?:'primary'|'primary-5'|'neutral-2'|'neutral-3'|'success'|'info'|'error'|'none',
