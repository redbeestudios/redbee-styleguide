/*! For license information please see 120.b2e9c8d0.iframe.bundle.js.LICENSE.txt */
    ...
    './node_modules/html2canvas/dist/html2canvas.js': function (module) {
      module.exports = (function () {
        ...
        for (
          var decode$1 = function (base64) {
              ...
              var buffer =
                ...
                bytes = Array.isArray(buffer) ? buffer : new Uint8Array(buffer);
              for (i = 0; i < len; i += 4)
            ...
            UTRIE2_INDEX_1_OFFSET$1 =
              UTRIE2_LSCP_INDEX_2_OFFSET$1 + (1024 >> UTRIE2_SHIFT_2$1) + 32,
            UTRIE2_OMITTED_BMP_INDEX_1_LENGTH$1 = 65536 >> UTRIE2_SHIFT_1$1,
            UTRIE2_INDEX_2_MASK$1 =
              (1 << (UTRIE2_SHIFT_1$1 - UTRIE2_SHIFT_2$1)) - 1,
            ...
            slice32$1 = function (view, start, end) {
              return view.slice
                ? view.slice(start, end)
                : new Uint32Array(Array.prototype.slice.call(view, start, end));
            },
            createTrieFromBase64$1 = function (base64, _byteLength) {
              var buffer = decode$1(base64),
                ...
                headerLength = 24,
                index = slice16$1(view16, headerLength / 2, view32[4] / 2),
                data =
                  2 === view32[5]
                    ...
                    if (codePoint < this.highStart)
                      return (
                        ...
                        (ix +=
                          ...
                          UTRIE2_INDEX_2_MASK$1),
                        (ix =
                          ((ix = this.index[ix]) << UTRIE2_INDEX_SHIFT$1) +
                          (codePoint & UTRIE2_DATA_MASK$1)),
                        this.data[ix]
                      );
        ...
        var LETTER_NUMBER_MODIFIER = 50,
          ...
          BREAK_NOT_ALLOWED$1 = '×',
          BREAK_ALLOWED$1 = '÷',
          UnicodeTrie$1 = createTrieFromBase64$1(
          ...
          _lineBreakAtIndex = function (
            ...
            if (0 === indicies[index]) return BREAK_NOT_ALLOWED$1;
            ...
            if (-1 !== HARD_LINE_BREAKS.indexOf(current))
              return BREAK_MANDATORY;
            if (-1 !== HARD_LINE_BREAKS.indexOf(next))
              return BREAK_NOT_ALLOWED$1;
            if (-1 !== SPACE$1.indexOf(next)) return BREAK_NOT_ALLOWED$1;
            ...
            if (-1 === [SP, BA, HY].indexOf(current) && next === GL)
              return BREAK_NOT_ALLOWED$1;
            if (-1 !== [CL, CP, EX, IS, SY].indexOf(next))
              return BREAK_NOT_ALLOWED$1;
            ...
            if (-1 !== [BA, HY, NS].indexOf(next) || current === BB)
              return BREAK_NOT_ALLOWED$1;
            if (before === HL && -1 !== HYPHEN.indexOf(current))
              return BREAK_NOT_ALLOWED$1;
            ...
            if (-1 !== [NU, SY, IS, CL, CP].indexOf(next))
              for (var prevIndex = currentIndex; prevIndex >= 0; ) {
                if ((type = classTypes[prevIndex]) === NU)
                  return BREAK_NOT_ALLOWED$1;
            ...
            if (
              ...
              return BREAK_NOT_ALLOWED$1;
            if (current === IS && -1 !== ALPHABETICS.indexOf(next))
              return BREAK_NOT_ALLOWED$1;
            if (
              (-1 !== ALPHABETICS.concat(NU).indexOf(current) &&
                next === OP &&
          ...
          isValidEscape = function (c1, c2) {
            return c1 === REVERSE_SOLIDUS && c2 !== LINE_FEED;
          },
          isIdentifierStart = function (c1, c2, c3) {
            return c1 === HYPHEN_MINUS
              ? isNameStartCodePoint(c2) || isValidEscape(c2, c3)
              : !!isNameStartCodePoint(c1) ||
                  !(c1 !== REVERSE_SOLIDUS || !isValidEscape(c1, c2));
          },
          isNumberStart = function (c1, c2, c3) {
            return c1 === PLUS_SIGN || c1 === HYPHEN_MINUS
              ? !!isDigit(c2) || (c2 === FULL_STOP && isDigit(c3))
              : isDigit(c1 === FULL_STOP ? c2 : c1);
          },
          stringToNumber = function (codePoints) {
            var c = 0,
              sign = 1;
            (codePoints[c] !== PLUS_SIGN && codePoints[c] !== HYPHEN_MINUS) ||
              (codePoints[c] === HYPHEN_MINUS && (sign = -1), c++);
            for (var integers = []; isDigit(codePoints[c]); )
              integers.push(codePoints[c++]);
            var int = integers.length
              ? parseInt(fromCodePoint$1.apply(void 0, integers), 10)
              : 0;
            codePoints[c] === FULL_STOP && c++;
            ...
            var fracd = fraction.length,
              frac = fracd
                ...
                : 0;
            (codePoints[c] !== E && codePoints[c] !== e) || c++;
            var expsign = 1;
            (codePoints[c] !== PLUS_SIGN && codePoints[c] !== HYPHEN_MINUS) ||
              (codePoints[c] === HYPHEN_MINUS && (expsign = -1), c++);
          ...
          Tokenizer = (function () {
            ...
            return (
                  ...
                  case NUMBER_SIGN:
                    ...
                    if (isNameCodePoint(c1) || isValidEscape(c2, c3)) {
                      var flags = isIdentifierStart(c1, c2, c3)
                        ? FLAG_ID
                        : FLAG_UNRESTRICTED;
                      return { type: 5, value: this.consumeName(), flags };
                    }
                    break;
                  case DOLLAR_SIGN:
                  ...
                  case SOLIDUS:
                    if (this.peekCodePoint(0) === ASTERISK)
                      for (this.consumeCodePoint(); ; ) {
                        ...
                        if (
                          c === ASTERISK &&
                          (c = this.consumeCodePoint()) === SOLIDUS
                        )
              ...
              (Tokenizer.prototype.consumeUnicodeRangeToken = function () {
                ...
                for (
                  var questionMarks = !1;
                  codePoint === QUESTION_MARK && digits.length < 6;
                ...
                if (
                  ...
                  return {
                    type: 30,
                    start,
                    end: parseInt(fromCodePoint$1.apply(void 0, endDigits), 16),
                  };
                }
              ...
              (Tokenizer.prototype.consumeIdentLikeToken = function () {
                ...
                return 'url' === value.toLowerCase() &&
                  ...
                  : this.peekCodePoint(0) === LEFT_PARENTHESIS
                  ? (this.consumeCodePoint(), { type: 19, value })
                  : { type: 20, value };
              }),
              ...
              (Tokenizer.prototype.consumeNumericToken = function () {
                var _a = this.consumeNumber(),
                  ...
                  c2 = this.peekCodePoint(1),
                  c3 = this.peekCodePoint(2);
                return isIdentifierStart(c1, c2, c3)
                  ? { type: 15, number, flags, unit: this.consumeName() }
                  : c1 === PERCENTAGE_SIGN
                  ? (this.consumeCodePoint(), { type: 16, number, flags })
                  : { type: 17, number, flags };
              }),
          ...
          Parser = (function () {
            ...
            return (
              ...
              (Parser.prototype.consumeSimpleBlock = function (type) {
                for (
                  var block = { type, values: [] }, token = this.consumeToken();
                  ;
        ...
        var hsl = function (context, args) {
            ...
            switch (gradient.size) {
              ...
              case 3:
                if (0 === gradient.shape)
                  ...
                  var _b = findCorner(width, height, x, y, !1);
                  (cx = _b[0]),
                    (cy = _b[1]),
                    (ry = c * (rx = distance(cx - x, (cy - y) / c)));
                }
          ...
          prefixRadialGradient = function (context, tokens) {
            ...
            return (
              ...
              { size, shape, stops, position, type: 2 }
            );
          },
          isLinearGradient = function (background) {
            return 1 === background.type;
          },
          isRadialGradient = function (background) {
            return 2 === background.type;
          },
          image = {
            name: 'image',
            parse: function (context, value) {
          ...
          SUPPORTED_IMAGE_FUNCTIONS = {
                ...
                parseFunctionArgs(tokens).forEach(function (arg, i) {
                  if (0 === i) {
                    ...
                    if (20 === firstToken.type && 'to' === firstToken.value)
                      return void (angle$1 = parseNamedSide(arg));
                    if (isAngle(firstToken))
                      return void (angle$1 = angle.parse(context, firstToken));
                  }
                  var colorStop = parseColorStop(context, arg);
                  stops.push(colorStop);
                }),
            ...
            '-webkit-gradient': function (context, tokens) {
              ...
              return (
                parseFunctionArgs(tokens).forEach(function (arg, i) {
                  ...
                  if (18 === firstToken.type)
                    if ('from' === firstToken.name) {
                      ...
                      (color = color$1.parse(context, firstToken.values[0])),
                      ...
                      if (2 === values.length) {
                        color = color$1.parse(context, values[1]);
                        var stop_1 = values[0];
                ...
                1 === type
                  ? { angle: (angle + deg(180)) % deg(360), stops, type }
        ...
        for (
          var decode = function (base64) {
            ...
            UTRIE2_INDEX_1_OFFSET =
              UTRIE2_LSCP_INDEX_2_OFFSET + (1024 >> UTRIE2_SHIFT_2) + 32,
            UTRIE2_OMITTED_BMP_INDEX_1_LENGTH = 65536 >> UTRIE2_SHIFT_1,
            UTRIE2_INDEX_2_MASK = (1 << (UTRIE2_SHIFT_1 - UTRIE2_SHIFT_2)) - 1,
            ...
            createTrieFromBase64 = function (base64, _byteLength) {
              var buffer = decode(base64),
                ...
                view16 = Array.isArray(buffer)
                  ...
                  : new Uint16Array(buffer),
                headerLength = 24,
                index = slice16(view16, headerLength / 2, view32[4] / 2),
                data =
                  2 === view32[5]
                  ...
                  if (codePoint >= 0) {
                    ...
                    if (codePoint < this.highStart)
                      return (
                        ...
                        (ix =
                          ((ix = this.index[ix]) << UTRIE2_INDEX_SHIFT) +
                          (codePoint & UTRIE2_DATA_MASK)),
                        this.data[ix]
                      );
                    if (codePoint <= 1114111)
        ...
        var PseudoElementType,
          ...
          _graphemeBreakAtIndex = function (_codePoints, classTypes, index) {
            ...
            if (next === CR || next === LF || next === Control)
              return BREAK_ALLOWED;
            if (current === L && -1 !== [L, V, LV, LVT].indexOf(next))
              return BREAK_NOT_ALLOWED;
            if (
              !((current !== LV && current !== V) || (next !== V && next !== T))
            )
              return BREAK_NOT_ALLOWED;
            ...
            if (current === ZWJ && next === Extended_Pictographic) {
              for (; prev === Extend; ) prev = classTypes[--prevIndex];
          ...
          testIOSLineBreak = function (document) {
            ...
            return document.body.removeChild(testElement), supports;
          },
          testCORS = function () {
            ...
            return (
              ...
              loadSerializedSVG$1(svg)
                ...
                .then(function (img) {
                  return (
                    ctx.drawImage(img, 0, 0),
                    isGreenPixel(ctx.getImageData(0, 0, size, size).data)
                  );
                })
                .catch(function () {
                  return !1;
          ...
          FEATURES = {
            ...
            get SUPPORT_NATIVE_TEXT_SEGMENTATION() {
              var value = !('undefined' == typeof Intl || !Intl.Segmenter);
              return (
                Object.defineProperty(
                  FEATURES,
                ...
                _loop_1 = function () {
                  if (bk.value) {
                    var value = bk.value.slice(),
                      codePoints = toCodePoints$1(value),
                      word_1 = '';
          ...
          createCJKCounter = function (
            ...
            for (var digit = 0; tmp > 0 && digit <= 4; digit++) {
              ...
              0 === coefficient && contains(flags, CJK_ZEROS) && '' !== string
        ...
        var getCurvePoints = function (x, y, r1, r2, position) {
          ...
          calculateBackgroundPositioningArea = function (
            backgroundOrigin,
            element
          ) {
          ...
          calculateBackgroundRendering = function (
            ...
            var backgroundPositioningArea = calculateBackgroundPositioningArea(
              ...
              backgroundPaintingArea = calculateBackgroundPaintingArea(
                getBackgroundValueForIndex(
              ...
              (CanvasRenderer.prototype.renderStack = function (stack) {
                return __awaiter(this, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return stack.element.container.styles.isVisible()
                          ...
                          (_loop_1 = function (backgroundImage) {
                            ...
                            return __generator(this, function (_h) {
                              switch (_h.label) {
                                ...
                                case 5:
                                  isLinearGradient(backgroundImage)
                            ...
                            styles.boxShadow
                              ...
                              .forEach(function (shadow) {
                                ...
                                var borderBoxArea = calculateBorderBoxPath(
                                  ...
                                  maskOffset = shadow.inset ? 0 : MASK_OFFSET,
                                  shadowPaintingArea = transformPath(
                                    borderBoxArea,
                                    -maskOffset +
                                      (shadow.inset ? 1 : -1) *
                  ...
                  case 0:
                    ...
                    return (
                      ...
                      (contextOptions = __assign(
                        {
                          logging:
                            null === (_e = opts.logging) || void 0 === _e || _e,
                          cache: opts.cache,
                        },
                        resourceOptions
                      )),
